const configDE = {
  ...
  pageSize: 24,
  productAttributes: [
    { name: "mak_bratype", id: "6a7690a543ac5d2bf54cce7ce5ad07e8" },
    { name: "mak_athletic", id: "5822c225491c057949bd0cb3c3958153" },
    { name: "mak_tear_drop", id: "4f1aa0bd5d3b32958eb7f807d944068b" },
    { name: "mak_relaxed", id: "e29f05d57dbb8947c3d9687456b80a74" },
    { name: "mak_asymmetric", id: "ef24da50345469c270e08660ddbf3894" },
    { name: "mak_side_set", id: "2a8e7b5b66a54ddaa65adcc353073c56" },
  ],
  materialAttributes: [
    { name: "mak_soft", id: "62610bf632e4092e0b20d87014b43036" },
    { name: "mak_mid", id: "67466e802fc50201a5dbe55ae876c976" },
    { name: "mak_firm", id: "f8871987f6b81257e31acf903d8b3956" },
  ],
  colorAttributes: [
    { name: "mak_color", id: "6f5e53ec7fe9a547e7981fbeaa0bf925" },
  ],
  andAttributes: [
    { name: "mak_wadding", id: "baf2776f9d336649cef33da7a876610c" },
    { name: "mak_color", id: "6f5e53ec7fe9a547e7981fbeaa0bf925" },
    { name: "PARENT_Kollektion", id: "021fe04031778246b067f2ba40b490fb" },
    { name: "mak_feature", id: "17b3d161564db46b1dd5bbb5188ec593" },
    { name: "mak_bh_pattern", id: "66e4308c12fc3c3712b33ef846149c8b" },
    { name: "attribute_style", id: "252230ca6ddf96e6172b6aa1f1b69083" },
  ],
  variantAndAttributes: [
    { name: "mak_bh_size", id: "c59b25d310f49ee20b8b308d3c7d3f3c" },
  ],
  defaultFilter: [
    {
      field: "SUS_PRODUCTTYPE",
      operator: "eq",
      value: ["bra", "bra.sport", "bra.bralette"],
    },
  ],
  beachFashionFilter: [
    {
  ...
  otherNotFilter: [
    ...
    {
      field: "manufacturer_title",
      operator: "eq",
      value: "SALE",
    },
  ],
  productImgBasePath: (number) =>
    `/out/pictures/generated/product/${number}/400_601_75/`,
  makaira: {
    host: "https://sugarshape.makaira.io",
  },
  questions: [
    {
      id: "size",
      ...
      options: [
        {
          ...
          attributes: [{ name: "mak_feature", value: "T-Shirt-BHs" }],
          excludes: [],
        },
        {
          title: "ohne Bügel",
          ...
          attributes: [{ name: "mak_feature", value: "bügellose BHs" }],
          excludes: [],
        },
        {
          ...
          attributes: [
            { name: "mak_feature", value: "Spitzen-BHs" },
            { name: "attribute_style", value: "trendy" },
          ],
          excludes: [
            { name: "PARENT_Kollektion", value: "Rosalie" },
            { name: "PARENT_Kollektion", value: "Blossom" },
            { name: "PARENT_Kollektion", value: "Emma" },
          ],
        },
        {
          title: "starker Halt",
          ...
          attributes: [
            { name: "mak_feature", value: "T-Shirt-BHs" },
            { name: "mak_bh_pattern", value: "Bralettes" },
            { name: "mak_bh_pattern", value: "Sport-BHs" },
          ],
          excludes: [
            { name: "PARENT_Kollektion", value: "LUCY" },
            { name: "PARENT_Kollektion", value: "GRACE" },
            { name: "PARENT_Kollektion", value: "STARS" },
            { name: "PARENT_Kollektion", value: "FLOW" },
            { name: "PARENT_Kollektion", value: "ROYAL DELITE," },
            { name: "PARENT_Kollektion", value: "ROYAL DIVA" },
            { name: "PARENT_Kollektion", value: "ROYAL FIT" },
            { name: "PARENT_Kollektion", value: "ROYAL MAGIC" },
            { name: "PARENT_Kollektion", value: "ROYAL MIRACLE" },
            { name: "PARENT_Kollektion", value: "ROYAL PUSH" },
          ],
        },
        {
          ...
          attributes: [
            { name: "mak_bh_pattern", value: "Demi-BHs" },
            { name: "mak_bh_pattern", value: "Plunge-BHs" },
          ],
          excludes: [],
        },
        {
          ...
          attributes: [
            { name: "mak_feature", value: "Multiway-BHs" },
            { name: "mak_bh_pattern", value: "Balconette-BHs" },
            { name: "mak_feature", value: "Spacer-BHs" },
            { name: "mak_bh_pattern", value: "Bralettes" },
            { name: "mak_bh_pattern", value: "Sport-BHs" },
            { name: "mak_bh_pattern", value: "Full-Cup-BHs" },
          ],
          excludes: [],
        },
        {
          ...
          attributes: [{ name: "mak_feature", value: "Multiway-BHs" }],
          excludes: [],
        },
        {
          ...
          attributes: [
            { name: "mak_wadding", value: "unwattiert" },
            { name: "mak_wadding", value: "leicht wattiert" },
            { name: "mak_wadding", value: "unwattiert" },
            { name: "mak_wadding", value: "leicht wattiert" },
          ],
          excludes: [],
        },
        {
          ...
          attributes: [
            { name: "mak_wadding", value: "wattiert" },
            { name: "mak_wadding", value: "Push-up" },
          ],
          excludes: [],
        },
        {
      ...
      options: [
        {
          ...
          attributes: [{ name: "mak_athletic", value: "Top Recommended" }],
          excludes: [],
          fullSize: true,
        },
        {
          ...
          attributes: [{ name: "mak_tear_drop", value: "Top Recommended" }],
          excludes: [],
          fullSize: true,
        },
        {
          ...
          attributes: [{ name: "mak_relaxed", value: "Top Recommended" }],
          excludes: [],
          fullSize: true,
        },
        {
          ...
          attributes: [{ name: "mak_asymmetric", value: "Top Recommended" }],
          excludes: [],
          fullSize: true,
        },
        {
          ...
          attributes: [{ name: "mak_side_set", value: "Top Recommended" }],
          excludes: [],
          fullSize: true,
        },
        {
      ...
      options: [
        {
          ...
          attributes: [{ name: "mak_soft", value: "Top Recommended" }],
          excludes: [],
        },
        {
          title: "Mittel",
          ...
          attributes: [{ name: "mak_mid", value: "Top Recommended" }],
          excludes: [],
        },
        {
          title: "Fest",
          ...
          attributes: [{ name: "mak_firm", value: "Top Recommended" }],
          excludes: [],
        },
        {
          title: "Ich weiß es nicht.",
